 ...
 */
void __termina_sys_print__print_char(const char value);
void __termina_sys_print__print_char_mutex(const char value);
void __termina_sys_print__print_char_task_lock(const char value);
void __termina_sys_print__print_char_event_lock(const char value);

/**
 * \brief Prints a character followed by a newline.
 */
void __termina_sys_print__println_char(const char value);
void __termina_sys_print__println_char_mutex(const char value);
void __termina_sys_print__println_char_task_lock(const char value);
void __termina_sys_print__println_char_event_lock(const char value);
