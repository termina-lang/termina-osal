 ...
 */
void SystemEntry__print_mutex(const size_t size, const char str[size]);
void SystemEntry__print_task_lock(const size_t size, const char str[size]);
void SystemEntry__print_event_lock(const size_t size, const char str[size]);

/**
 * \brief Prints a zero-terminated string followed by a newline.
 */
void SystemEntry__println_mutex(const size_t size, const char str[size]);
void SystemEntry__println_task_lock(const size_t size, const char str[size]);
void SystemEntry__println_event_lock(const size_t size, const char str[size]);
